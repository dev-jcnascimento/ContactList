...
Feito - Seria uma boa se pontos críticos do código tivessem testes unitários.
Feito - Adicionar autenticação na API seria interessante.
Feito - Poder exportar a agenda completa também seria legal.
